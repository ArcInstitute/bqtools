...
pub fn encode_single_fastq<W: Write>(in_handle: Box<dyn Read>, out_handle: W) -> Result<()> {
...
/// Encode a pair of FASTQ files into a binary format
pub fn encode_paired_fastq<W: Write>(
