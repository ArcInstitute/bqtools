...
pub struct VbqEncoder<W: Write + Send> {
    /* Thread-local fields */
...
impl<W: Write + Send> VbqEncoder<W> {
...
impl<W: Write + Send> Clone for VbqEncoder<W> {
    fn clone(&self) -> Self {
        Self {
...
impl<W: Write + Send, Rf: paraseq::Record> ParallelProcessor<Rf> for VbqEncoder<W> {
...
impl<W: Write + Send, Rf: paraseq::Record> PairedParallelProcessor<Rf> for VbqEncoder<W> {
...
impl<W: Write + Send> binseq::ParallelProcessor for VbqEncoder<W> {
