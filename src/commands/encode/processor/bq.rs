...
pub struct BqEncoder<W: Write + Send> {
    /* Thread-local fields */
...
impl<W: Write + Send> Clone for BqEncoder<W> {
    fn clone(&self) -> Self {
        Self {
...
impl<W: Write + Send, Rf: paraseq::Record> ParallelProcessor<Rf> for BqEncoder<W> {
...
impl<W: Write + Send, Rf: paraseq::Record> PairedParallelProcessor<Rf> for BqEncoder<W> {
